...
def get_import_path(py_path, src_dir, import_base="package"):
...
def generate_markdown_for_py(py_path, md_path, src_dir, import_base="package"):
...
def crawl_and_generate_markdown(src_dir, dst_dir, import_base="package"):
    """
...
def main():
    ...
    structure = crawl_and_generate_markdown(source_directory, destination_directory, import_base="package")
